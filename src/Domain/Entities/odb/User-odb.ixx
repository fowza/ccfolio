...
inline void access::object_traits_impl<::User, id_mysql>::erase(database &db, const object_type &obj)
{
...
inline void access::object_traits_impl<::User, id_mysql>::load_(statements_type &sts, object_type &obj, bool)
{
